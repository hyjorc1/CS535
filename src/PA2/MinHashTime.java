...
public class MinHashTime {
    public static void timer(String folder, int numPermutations) {
        ...
        System.out.println(
                "The time taken to construct an instance of MinHashSimilarities: " + (after - before) / 1000.0 + " s");
        ...
        System.out.println("Exact Jaccard Time: " + (after - before) / 1000.0 + " s");
        ...
        after = System.currentTimeMillis();
        System.out.println("Approximate Jaccard Time: " + (after - before) / 1000.0 + " s");
    }
}
