...
class Employee implements Comparable<Employee> {
    ...
    public int compareTo(Employee employee) {
    		if (this.getName().equals(employee.getName()))
    			return 0;
        return this.getId() == employee.getId() ? 1 : this.getId() - employee.getId();
    }
...
public class TreeSetUserDefinedObjectExample {
    public static void main(String[] args) {
        ...
        */
        ...
        employees.add(new Employee(1008, "Chris1"));
        employees.remove(new Employee(200000, "Chris"));
        employees.add(new Employee(200000, "Chris"));
